    ...
    <div>
      <div className="table__view select-user-table">
            ...
            <thead>
              ...
              <tbody {...getTableBodyProps()} className="table-body">
                {rows.map((row, index) => {
                  prepareRow(row);
                  return (
                    <tr {...row.getRowProps()} onClick={() => onSelectAsset(row.original)}>
                        <label htmlFor={index}>
                          {row.cells.map((cell) => {
                            return (
        ...
        <div className="user-control">
          <div className="user-btn save" onClick={onSaveAssetModal}>Save</div>
          <div className="user-btn cancel" onClick={onCancelAssetModal}>Cancel</div>
        </div>
      </div>
    </div>
  );
